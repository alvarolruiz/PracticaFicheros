...
public class Constantes {
    ...
    protected static final int LONGITUD_NOMBRE=25; // 25*2 (char)
    protected static final int LONGITUD_APELLIDO=25; // 25*2 (char)
    protected static final int LONGITUD_DNI=9; // 9*2 (char)
    protected static final int LONGITUD_TELEFONO=9; // 9*4 (int)
    protected static final int LONGITUD_DIRECCION=30; // 30*2 (char)
